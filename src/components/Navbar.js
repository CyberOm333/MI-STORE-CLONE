...
const Navbar = () => {
  return (
   ...
   <a   className="navlinks" href="https://www.mi.com/in/life-style#apparels-shoes-more">Fitness & Lifestyle</a>
   ...
   <a   className="navlinks" href="https://www.mi.com/in/smart-home#smart-appliances">Accessories</a>
